...
| Embed generation | Checks that GitHub-like payloads produce the expected Discord embeds, including commit-author attribution, branch lifecycle titles, and generic fallback behavior |
